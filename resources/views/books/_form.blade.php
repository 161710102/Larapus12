<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}"> 
	...
	<div class="col-md-4"> {!! Form::text('title', null, ['class'=>'form-control']) !!} 
...
<div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}"> 
	...
	<div class="col-md-4"> 
		...
		@if (isset($book)) 
		<p class="help-block">
			{{ $book->borrowed }} buku sedang dipinjam</p> 
			@endif 
	</div> 
</div>
...
<div class="form-group{{ $errors->has('cover') ? ' has-error' : '' }}"> 
	...
	<div class="col-md-4"> {!! Form::file('cover') !!} @if (isset($book) && $book->cover) 
		<p>
			{!! Html::image(asset('img/'.$book->cover), null, ['class'=>'img-rounded img-responsive\ ']) !!} 
		</p> @endif {!! $errors->first('cover', '
